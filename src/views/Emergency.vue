              ...
              <v-container fluid>
                ...
                <v-row>
                  <v-container>
                    <h2>United States</h2>
                    <br />
                    <v-container id="resources">
                      <div id="resources">
                        <v-list-item>911 Emergency</v-list-item>
                        <v-list-item>
                          <a id="phone">+1 (800) 799-7233</a>
                        ...
                        <v-list-item>
                          <a id="phone">+1 (800) 622-2255</a>
                          Alcoholism & Drug Dependency Hope Line
                        </v-list-item>
                        <v-list-item>
                          <a id="phone">+1 (800) 233-4357</a>
                          National Crisis Line, Anorexia and Bulimia
                        </v-list-item>
                        <v-list-item>
                          <a id="phone">+1 (800) 843-4564</a>
                          GLBT Hotline
                        </v-list-item>
                        <v-list-item>
                          <a id="phone">+1 (800) 488-7386</a> TREVOR Crsis
                          Hotline
                        </v-list-item>
                        <v-list-item>
                        ...
                        <v-list-item>
                          <a id="phone">+1 (800) 422-4453</a>The Childhelp
